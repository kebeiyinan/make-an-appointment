	...
	<div class="page-content">
		<div class="row maintop">
			<div style="margin:10px 0;" id="rule-add">
				<form class="form-horizontal ajaxForm2" name="admin_rule_add" method="post" action="<?php echo U('admin_rule_runadd');?>">
					<div class="col-xs-12 col-sm-12">
						...
						<small class="sl-left10">块/控/方：</small>
			...
			<div class="col-xs-12 col-sm-12 rule-top alert alert-info top10">
				...
				1、《块/控/方》：意思是 模块/控制器/方法; 例如 Admin/Sys/sys_list<br />
				2、菜单name检测规则：一级菜单=>模块/控制器名，二级菜单=>模块/控制器/方法，三级、四级菜单=>模块/控制器/方法<br />
				3、css为控制左侧导航顶级栏目前图标样式(仅一级菜单有效)，具体可查看FontAwesome图标CSS样式
			</div>
			<div class="row">
				<div class="col-xs-12">
					<div>
						<form class="ajaxForm" name="ruleorder" method="post" action="<?php echo U('admin_rule_order');?>" >
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($admin_rule)): foreach($admin_rule as $key=>$v): ?><tr>
										<td height="28"><?php echo ($key +1); ?></td>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="<?php echo U('admin_rule_copy',array('id'=>$v['id']));?>" title="复制">
													<i class="ace-icon fa fa-exchange bigger-130"></i>
												</a>
												<a class="red confirm-rst-url-btn" href="<?php echo U('admin_rule_del',array('id'=>$v['id']));?>" data-info="你确定要删除吗？" title="删除">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline position-relative">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<li>
															<a href="<?php echo U('admin_rule_edit',array('id'=>$v['id']));?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																			<span class="green">
														...
														<li>
															<a href="<?php echo U('admin_rule_del',array('id'=>$v['id']));?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																			<span class="red">
